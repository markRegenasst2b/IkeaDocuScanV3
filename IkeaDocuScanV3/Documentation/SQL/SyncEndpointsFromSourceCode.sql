...
-- Counter Parties - GET endpoints (Publisher, ADAdmin, SuperUser) - Reader access REMOVED
INSERT INTO [dbo].[EndpointRolePermission] ([EndpointId], [RoleName], [CreatedBy])
...
-- Countries - GET operations (Publisher, ADAdmin, SuperUser) - Reader access REMOVED
INSERT INTO [dbo].[EndpointRolePermission] ([EndpointId], [RoleName], [CreatedBy])
...
-- Currencies - GET operations (Publisher, ADAdmin, SuperUser) - Reader access REMOVED
INSERT INTO [dbo].[EndpointRolePermission] ([EndpointId], [RoleName], [CreatedBy])
...
-- Document Types - GET operations (Publisher, ADAdmin, SuperUser) - Reader access REMOVED
INSERT INTO [dbo].[EndpointRolePermission] ([EndpointId], [RoleName], [CreatedBy])
...
-- Document Names - GET operations (Publisher, ADAdmin, SuperUser) - Reader access REMOVED
INSERT INTO [dbo].[EndpointRolePermission] ([EndpointId], [RoleName], [CreatedBy])
